...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ein Blogartikel, der eine wissenschaftliche Arbeit aufbereitet';
    displayName: 'Article';
    pluralName: 'articles';
...
export interface ApiAuthorAuthor extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Profil des Autors (\u00DCber mich)';
    displayName: 'Author';
    pluralName: 'authors';
    singularName: 'author';
  };
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Fachliche Kategorie eines Artikels';
